...
data.raw.item['wood-charcoal'].fuel_value = multiply_fuel_value("4MJ", fuel_factor_solid)
data.raw.item['pellet-coke'].fuel_value = multiply_fuel_value("24MJ", fuel_factor_solid)

-- multiply other fuel values with factor
data.raw.item['cellulose-fiber'].fuel_value = multiply_fuel_value(data.raw.item['cellulose-fiber'].fuel_value, fuel_factor_solid)
data.raw.item['wood'].fuel_value = multiply_fuel_value(data.raw.item['wood'].fuel_value, fuel_factor_solid)
data.raw.item['wood-pellets'].fuel_value = multiply_fuel_value(data.raw.item['wood-pellets'].fuel_value, fuel_factor_solid)
data.raw.item['solid-fuel'].fuel_value = multiply_fuel_value(data.raw.item['solid-fuel'].fuel_value, fuel_factor_solid)
data.raw.item['solid-carbon'].fuel_value = multiply_fuel_value(data.raw.item['solid-carbon'].fuel_value, fuel_factor_solid)

if data.raw.fluid['hydrazine'] then
  data.raw.fluid['hydrazine'].fuel_value = multiply_fuel_value(data.raw.fluid['hydrazine'].fuel_value, fuel_factor_fluid)
end
...
data.raw.fluid['liquid-fuel-oil'].fuel_value = multiply_fuel_value("1MJ", fuel_factor_fluid)
data.raw.fluid['liquid-fuel'].fuel_value = multiply_fuel_value("1MJ", fuel_factor_fluid)
data.raw.fluid['liquid-naphtha'].fuel_value = multiply_fuel_value("0.5MJ", fuel_factor_fluid)
data.raw.fluid['gas-methane'].fuel_value = multiply_fuel_value("0.5MJ", fuel_factor_fluid)
data.raw.fluid['crude-oil'].fuel_value = multiply_fuel_value("0.5MJ", fuel_factor_fluid)
-- 20 petroleum gas + 20 light fuel = 30 diesel
-- 20/100*21.5 + 20/50*21.5 = 12.9MJ = 30 diesel
if data.raw.fluid['diesel-fuel'] then
  data.raw.fluid['diesel-fuel'].fuel_value = multiply_fuel_value("1MJ", fuel_factor_fluid)
end
data.raw.item['enriched-fuel'].fuel_value = multiply_fuel_value("50MJ", fuel_factor_solid)
